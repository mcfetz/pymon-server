...
AGENTID="{agentid}"
APIKEY="{apikey}"
DIR="${{HOME:-/tmp}}/pymon-agent-$AGENTID"
mkdir -p "$DIR/plugins"
cd "$DIR"
...
echo ""
echo "Install as a system-wide systemd service:"
echo "  cd $DIR && sudo python3 agent.py --install --agentid $AGENTID"
echo ""
echo "Uninstall the system-wide systemd service:"
echo "  cd $DIR && sudo python3 agent.py --uninstall --agentid $AGENTID"
"""
